...
class UpdateProductVariantRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user() && $this->user()->isVendor() && $this->user()->isApproved() && $variant && $variant->product->user_id === $this->user()->id;
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'sku.unique' => 'You already have another product variant registered with this SKU.',
